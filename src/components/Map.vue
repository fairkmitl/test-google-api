...
export default {
  ...
  data() {
    return {
      ...
      // Defualt center,
      DEFAULT_LAT: 13.8005827,
      DEFAULT_LNG: 100.5410026,
  ...
  mounted: function() {
    // Google API key
    $Scriptjs(
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyDplHB_p6lvK714jg7QMN3PKCmB_47K-yU&libraries=geometry,places",
      () => {
        this.initMap();
      }
    );
  ...
  methods: {
    ...
    renderCityMap(myCityData) {
      ...
      // Pass clicks on to the underlying map
